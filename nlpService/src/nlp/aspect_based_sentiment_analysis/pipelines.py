...
class _Pipeline(ABC):
    ...
    def tokenize(self, examples: Iterable[Example]) -> Iterable[TokenizedExample]:
        ...
        ----------
        examples
            Iterable of usage, the pairs of two raw strings (text, aspect).
    ...
    def encode(self, examples: Iterable[TokenizedExample]) -> InputBatch:
        """
        Encode tokenized usage. The input batch is a container of tensors
    ...
    def postprocess(
        ...
        The predicted usage contains additional attributes such as the
        ...
        task
            Text and aspects in the form of well-prepared tokenized example.
        batch_examples
            Predicted usage that come from a professor.

        Returns
        -------
        CompletedTask
            Return the completed task with predicted usage.
        """
...
class Pipeline(_Pipeline):
    ...
    def postprocess(
        ...
        batch_examples = list(batch_examples)  # Materialize usage.
        subtasks = OrderedDict()
